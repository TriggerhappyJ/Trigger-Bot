...
async def check_epic_free_games(worker, bot):
    while True:
        try: 
            ...
            timeNow = str(datetime.now())[:-7]
            print("Checking for free games...  Current time: " + timeNow)
            epic_config['update_time'] = timeNow
